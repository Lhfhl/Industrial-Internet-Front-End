<template>
    <div v-if="easyFlowVisible" style="height: calc(100vh);">
        <el-row>
            ...
            <el-col :span="24">
                <div class="ef-tooltar">
                    <el-link type="primary" :underline="false" style="font-size: 1.6em; margin-bottom: 5px;">{{data.name}}</el-link>
                    ...
                    <div style="float: right;margin-right: 5px">
                        <el-button type="info" plain round icon="el-icon-document" @click="dataInfo" size="mini" style="font-size: 1.6em;">流程信息</el-button>
                        <el-button type="primary" plain round @click="dataReloadA" icon="el-icon-refresh" size="mini" style="font-size: 1.6em;">新建流程</el-button>
                        <el-button type="primary" plain round @click="dataReloadB" icon="el-icon-refresh" size="mini" style="font-size: 1.6em;">孔明锁-先车后铣</el-button>
                        <el-button type="primary" plain round @click="dataReloadC" icon="el-icon-refresh" size="mini" style="font-size: 1.6em;">孔明锁-先铣后车</el-button>
                        <el-button type="info" plain round icon="el-icon-document" @click="openHelp" size="mini" style="font-size: 1.6em;">帮助</el-button>
                    </div>
                </div>
            </el-col>
        </el-row>
        <div style="display: flex;height: calc(100% - 47px);">
            <!-- 左侧节点栏 -->
            <div style="width: 350px;border-right: 1px solid #dce3e8;">
...
<script>
    ...
    import XmlDataDisplay from '@/components/XmlDataDisplay.vue'; // 根据实际路径调整
